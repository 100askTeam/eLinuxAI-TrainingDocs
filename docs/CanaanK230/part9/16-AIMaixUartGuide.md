...
![image-20260605095806875](images/image-20260605095806875.png)

UART2:

![image-20260605095637418](images/image-20260605095637418.png)
...
实验**MX1.25超薄镀金端子线4P**连接开发板端的UART2口，另一端连接至串口模块。连接完成后将串口模块接入电脑的USB口。
