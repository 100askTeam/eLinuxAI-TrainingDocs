...
if __name__=="__main__":
    # 添加显示模式，默认hdmi，可选hdmi/lcd/lt9611/st7701/hx8399,其中hdmi默认置为lt9611，分辨率1920*1080；lcd默认置为aml020t，分辨率480*360
    display_mode="lcd"
...
![image-20250423183824019](${images}/image-20250423183824019.png)

> 注意：每次运行代码后会在下面路径文件夹生成特征数据**/sdcard/examples/utils/features/**，如遇到意外报错情况可以删除整个`features`文件夹重新运行代码即可。

![image-20250423190544804](${images}/image-20250423190544804.png)



运行代码后，可以根据屏幕提示苹果和香蕉的信息：

采集苹果特征：

![image-20250423191039023](${images}/image-20250423191039023.png)

采集香蕉特征：

![image-20250423191102425](${images}/image-20250423191102425.png)

识别苹果：

![image-20250423191048333](${images}/image-20250423191048333.png)

识别香蕉：

![image-20250423191055505](${images}/image-20250423191055505.png)
