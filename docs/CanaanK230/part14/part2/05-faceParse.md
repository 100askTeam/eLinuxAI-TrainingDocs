...
**人脸分割**是指对人脸图像进行像素级别的精细划分，将图像中的不同区域（如眼睛、鼻子、嘴巴、头发及背景等）区分开来并赋予明确的类别标签。
 相比于人脸检测或关键点定位，人脸分割不仅关注人脸的位置，还关注面部内部结构的具体区域划分，提供更丰富、更精确的语义信息。
...
​	点击运行代码后，可以在显示屏上看到人脸分割的结果。如下所示：

![image-20250423172743677](${images}/image-20250423172743677.png)
