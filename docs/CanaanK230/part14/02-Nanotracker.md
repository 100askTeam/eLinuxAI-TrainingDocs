...
点击运行之后，我们将演示对苹果进行跟踪，将苹果放进绿色矩形框。

![image-20250423184135201](${images}/image-20250423184135201.png)

等待矩形框变成红色后说明学习成功并开始追踪，接下来可以移动摄像头，可以发现一直跟踪苹果。

![image-20250423184226374](${images}/image-20250423184226374.png)
