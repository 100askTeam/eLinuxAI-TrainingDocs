...
![第二个图案](${images}/gpu-3-1721379510737-93.jpg)
...
1. 将配置文件和参考图文件放在`k230_sdk/src/big/rt-smart/userapps/root/bin/dpu`目录下，如下图所示： ![conf_file](${images}/demo_dpu_conf_ref_file_02140401.png)
