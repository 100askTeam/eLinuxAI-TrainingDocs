...
boards: [CanMV_V3]
---
# DshanPI-CanMV_V3 快速启动

## 硬件要求

### 盒子里包括的内容

当您购买了一套全新的DshanPI-CanMV_V3套件时，包装盒内会有：
...
要使用摄像头获取图像数据，如果您只单独购买了DshanPI-CanMV开发板，可能还需另外购买摄像头。下面图片是将后置摄像头连接到DshanPI-CanMV开发板的指南。

连接默认1080P的GC2093摄像头：

![image-20260721173547198](images/image-20260721173547198.png)

连接4K的OV13850摄像头：

![image-20260721173753534](images/image-20260721173753534.png)

### 连接前置摄像头

连接默认1080P的GC2093摄像头：

![image-20260721173929206](images/image-20260721173929206.png)

## 连接显示屏

要使用显示屏显示摄像头获取的图像，如果您只单独购买了DshanPI-CanMV开发板，可能还需另外购买MIPI显示屏。下面是将MIPI显示屏连接到DshanPI-CanMV开发板的指南。

![image-20260721174255327](images/image-20260721174255327.png)

## 开发板首次启动

 通过Type-C线将板连接到PC电脑，您可以使用DshanPI-CanMV盒子中的的Type-C线。

无外壳连接指南如下所示：

![image-20260721174515116](images/image-20260721174515116.png)
...
![image-20260721180207802](images/image-20260721180207802.png)

![image-20260721180440367](images/image-20260721180440367.png)
